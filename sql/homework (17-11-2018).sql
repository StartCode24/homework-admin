...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 17, 2018 at 05:58 PM
...
('3432432432', '342121240000000', 'Vina Malinda', 'Jalan Mawar 21', '31', '9', 'testing', NULL),
...
--
ALTER TABLE `siswa`
  ADD CONSTRAINT `siswa_ibfk_1` FOREIGN KEY (`siswa_jurusan`) REFERENCES `jurusan` (`jurusan_id`),
  ADD CONSTRAINT `siswa_ibfk_2` FOREIGN KEY (`siswa_kelas`) REFERENCES `kelas` (`kelas_id`);
COMMIT;

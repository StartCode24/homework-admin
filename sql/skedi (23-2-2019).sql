...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 22, 2019 at 06:59 PM
...
INSERT INTO `kelas` (`kelas_id`, `kelas_name`, `kelas_jurusan`, `kelas_sub`) VALUES
(1, '10', '13', 'A'),
(2, '10', '13', 'B'),
(3, '10', '6', '');
...
(9, 'Bahasa Jawa', ''),
(10, 'Kimia', 'Kimia'),
(11, 'Penjaskes', 'Penjaskes'),
(12, 'Gamb.Teknik ', 'Gamb.Teknik '),
(13, 'PPKn', ''),
(14, 'Dasar-Dasar Geologi', ''),
(15, 'Matematika', ''),
(16, 'K3LH', ''),
(17, 'Fisika', ''),
(18, 'SB', ''),
...
INSERT INTO `schedule` (`schedule_id`, `start_time`, `finish_time`, `day`, `jam_ke`, `note`, `guru_id`, `mapel_id`, `kelas_id`, `jurusan_id`, `room_id`) VALUES
(212334, '08:00:00', '09:00:00', 'Selasa', 0, NULL, '893488650', '4', '51', '11', '2'),
(356671, '09:00:00', '10:00:00', 'Senin', 0, NULL, '415656947', '4', '122', '5', '3'),
(432432, '09:00:00', '10:00:00', 'Jumat', 0, NULL, '287521762', '3', '51', '12', '3'),
(634643, '11:00:00', '13:00:00', 'Rabu', 0, NULL, '746952542', '4', '51', '14', '2'),
(3213213, '06:00:00', '08:00:00', 'Sabtu', 0, NULL, '1006974173', '9', '31', '9', '1'),
(3213214, '06:00:00', '08:00:00', 'Sabtu', 0, NULL, '1006974173', '9', '31', '9', '1'),
(3213215, '06:00:00', '08:00:00', 'Sabtu', 0, NULL, '1006974173', '9', '31', '9', '1'),
(6346432, '11:00:00', '13:00:00', 'Rabu', 0, NULL, '746952542', '4', '51', '14', '2'),
(34211177, '10:00:00', '12:00:00', 'Kamis', 0, NULL, '1018780774', '3', '31', '2', '2'),
(34211178, '00:00:00', '00:00:00', 'Senin', 1, NULL, '484522205', '0010', '1', '13', '830');
...
--
ALTER TABLE `mapel`
  MODIFY `mapel_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `room`
--
ALTER TABLE `room`
  MODIFY `room_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=831;

--
-- AUTO_INCREMENT for table `schedule`
--
ALTER TABLE `schedule`
  MODIFY `schedule_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34211179;
COMMIT;

...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 15, 2019 at 12:49 PM
...
('856852', '2018-12-06', '07:00:00', '08:00:00', 'Kamis', 0, NULL, '1389049999', '2', '31', '8', '3');
...
--
ALTER TABLE `homework`
  ADD CONSTRAINT `homework_ibfk_1` FOREIGN KEY (`schedule_id`) REFERENCES `schedule` (`schedule_id`);

									...
									<tbody>
										<?php foreach ($data as $value) { ?>
											<tr>
												...
												<td class="">
          <button class="btn btn-warning btn-fill" onclick="_edit_room('<?php echo $value['room_id'];?>')">
               Edit
             </button>
													||
													<button class="btn btn-danger" onclick="Swall_Delete_Room('<?php echo $value['room_id'];?> ')">Delete</button>
												</td>
											</tr>
										<?php } ?>
									</tbody>

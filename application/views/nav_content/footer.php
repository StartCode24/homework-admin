...
<!--     <nav class="pull-left">
    ...
    <p class="copyright pull-right">
      &copy; <script>document.write(new Date().getFullYear())</script> <a href="http://www.skedi.site">Skedi</a>, made with love for a better education.
    </p>
  </div>
</footer>
</div>
...
<script src=<?php echo base_url("assets/js/crud_schedule.min.js");?> type="text/javascript"></script>
<script src=<?php echo base_url("assets/js/crud_kelas.min.js");?> type="text/javascript"></script>

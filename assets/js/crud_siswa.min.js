// untuk pop upnya
  function _edit_siswa(siswa_id){
    // alert("hi");
    // untuk menampung isi data dari siswa id
    var datam={"siswa_id":siswa_id};
    var base_url = $('#base').val();
    var base_url2=base_url+'Siswa/';
  ...
  function Swall_Delete_Siswa(siswa_id){
  //  var kd_kary=kd_kar;

// untuk pop upnya
  function _edit_jurusan(jurusan_id){
    // alert("hi");
    // untuk menampung isi data dari jurusan id
    var datam={"jurusan_id":jurusan_id};
    var base_url = $('#base').val();
    var base_url2=base_url+'Jurusan/';
  ...
  function Swall_Delete_Jurusan(jurusan_id){
  //  var kd_kary=kd_kar;

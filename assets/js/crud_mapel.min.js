// untuk pop upnya
  function _edit_mapel(mapel_id){
    // alert("hi");
    // untuk menampung isi data dari room id
    var datam={"mapel_id":mapel_id};
    var base_url = $('#base').val();
    var base_url2=base_url+'Mapel/';
  ...
  function Swall_Delete_Mapel(mapel_id){
  //  var kd_kary=kd_kar;
